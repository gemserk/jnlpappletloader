...
public class HttpRequestEncodingTest {
	...
	public static void main(String[] args) throws Exception {
		...
		// URL url = new URL("http://www.gemserk.com/private/prototipos/zombierockers-webstart-latest/animation-0.0.3-SNAPSHOT.jar");

		URLConnection connection = url.openConnection();

		connection.addRequestProperty("Accept-Encoding", "pack200-gzip, gzip");
		// connection.addRequestProperty("Accept-Encoding", "gzip, *;q=0");
		connection.connect();
